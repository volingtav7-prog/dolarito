...
-- Fecha:     2026-07-13
-- Descripción: Schema inicial — tablas + índices (Sprint 1)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS historial_de_consultas (
...
CREATE INDEX IF NOT EXISTS idx_tipos_de_cambio_divisa ON tipos_de_cambio(id_divisa);
CREATE INDEX IF NOT EXISTS idx_favoritos_usuario      ON favoritos(id_usuario);
CREATE INDEX IF NOT EXISTS idx_favoritos_divisa       ON favoritos(id_divisa);
CREATE INDEX IF NOT EXISTS idx_historial_usuario      ON historial_de_consultas(id_usuario);
CREATE INDEX IF NOT EXISTS idx_historial_fecha        ON historial_de_consultas(fecha);
